...
library(dplyr)
## CBG 11 ----
clasificacion13 <- data.frame(fecha = as.Date("28/09/2020", format = "%d/%m/%Y"),
                              posicion = 3,
                              participantes = 7,
                              puntuacion = 108261,
                              liga = "Diamante"
)
cbg13 <- data.frame(fecha = rep(as.Date("28/09/2020", format = "%d/%m/%Y"), 36),
                    jugador = c("jefferson ospina", "emiliolt", "Richikev16", "cabma", "Uwe Albert",
                                "Madrada",  "ssevillano", "Nefertai158", "RamesesII", "rapegi1858",
                                "Octavia 277 la Benevola", "Manza1510", "MLAHOZM", "Matilda la guapa",
                                "Fer el tigre", "Fulvia 179 la Blanca", "scorpio82", "PasQ",
                                "Rodrigo 112 el Blanco", "Epicuro el Invencible",  "Libertiana", 
                                "mgara", "YaraPedrani", "diegosgm", "hidalgo la Grande", "Juan Skott",
                                "gapbrielle", "Josechan", "Lucila 165 la Fuerte", "Niebelungo", "espysg",
                                "Honoria 246 la Grande", "k3k02k13", "Lola indestructible", "Okartap",
                                "Faik"
                                ),
                    negociaciones = c(116, 46, 75, 0, 161, 80, 108, 10, 27, 106, 65, 11, 55, 60, 110, 100, 67,
                                      3, 40, 73, 55, 115, 33, 0, 0, 74, 0, 13, 0, 20, 18, 12, 12, 0, 7, 0),
                    batallas = c(1091, 1182, 1072, 1157, 783, 829, 680, 819, 775, 590, 577, 680, 565, 493,
                                 344, 352, 400, 512, 403, 318, 351, 203, 349, 381, 302, 143, 288, 261, 253,
                                 203, 140, 109, 57, 66, 40, 15)
                    )
...
## Clasificación
clasificacion <- rbind(clasificacion, clasificacion13)
